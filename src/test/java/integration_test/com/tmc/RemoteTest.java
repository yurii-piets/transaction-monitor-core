...
public class RemoteTest {
    ...
    public void runSuccessfulQueries() throws SQLException {
        ...
        ResultSet resultSet = testUtil.resultSetForSqlQuery(TMFOUR_QUALIFIER,
                "SELECT * FROM zamowienia WHERE idzamowienia=16 AND idklienta=15 AND opis='insert successful';");
        assertTrue(resultSet.next());

        ResultSet resultSet1 = testUtil.resultSetForSqlQuery(TMTHREE_QUALIFIER,
                "SELECT * FROM oceny " +
                        "WHERE idoceny=16 " +
                        "AND idstudenta=8 " +
                        "AND przedmiot='insert successful' " +
                        "AND ocena='4.5';");
        ...
        ResultSet resultSet4 = testUtil.resultSetForSqlQuery(TMTHREE_QUALIFIER,
    ...
    public void runFirstFailedAndSecondSuccessfulMixedTransactions() throws SQLException {
        ...
        ResultSet resultSet1 = testUtil.resultSetForSqlQuery(TMFOUR_QUALIFIER,
                "select * from klienci where idklienta=77");
        assertFalse(resultSet1.next());

        ResultSet resultSet2 = testUtil.resultSetForSqlQuery(TMTHREE_QUALIFIER,
        ...
        ResultSet resultSet5 = testUtil.resultSetForSqlQuery(TMFOUR_QUALIFIER,
                "select * from klienci where idklienta=77");
        assertFalse(resultSet5.next());

        ResultSet resultSet6 = testUtil.resultSetForSqlQuery(TMTHREE_QUALIFIER,
                "select * from studenci where idstudenta=7");
    ...
    public void runFirstSuccessfulAndSecondSuccessfulMixed() throws SQLException {
        ...
        transaction1.addStatement(TMFOUR_QUALIFIER,
                "update zamowienia set opis='update successful';");
        transaction1.addStatement(TMTHREE_QUALIFIER,
                "update studenci set nazwa='update successful' where wydzial='ieit';");

        transaction2.addStatement(TMFOUR_QUALIFIER,
                "insert into zamowienia values (16, 15, 'insert successful');");
        transaction2.addStatement(TMTHREE_QUALIFIER,
                "update oceny set ocena=1.0 where przedmiot like 'Fizyka%';");

        transaction1.commit();

        ResultSet resultSet1 = testUtil.resultSetForSqlQuery(TMFOUR_QUALIFIER,
                "select count(*) as total from zamowienia where opis='update successful'");
        resultSet1.next();
        assertEquals(14, resultSet1.getInt("total"));

        ResultSet resultSet2 = testUtil.resultSetForSqlQuery(TMTHREE_QUALIFIER,
                "select nazwa from studenci where wydzial='ieit';");
        if (resultSet2.next()) {
            do {
        ...
        ResultSet resultSet3 = testUtil.resultSetForSqlQuery(TMFOUR_QUALIFIER,
                "select * from zamowienia where idzamowienia=16;");
        assertFalse(resultSet3.next());

        ResultSet resultSet4 = testUtil.resultSetForSqlQuery(TMTHREE_QUALIFIER,
                "select ocena from oceny where przedmiot like 'Fizyka%'");
        if (resultSet4.next()) {
            do {
        ...
        ResultSet resultSet7 = testUtil.resultSetForSqlQuery(TMFOUR_QUALIFIER,
                "select * from zamowienia where idzamowienia=16;");
        assertTrue(resultSet7.next());

        ResultSet resultSet8 = testUtil.resultSetForSqlQuery(TMTHREE_QUALIFIER,
                "select ocena from oceny where przedmiot like 'Fizyka%'");
        if (resultSet8.next()) {
            do {
    ...
    public void runSuccessfulTransactionsInDifferentThreads() throws SQLException, InterruptedException {
        ...
        ResultSet resultSet2 = testUtil.resultSetForSqlQuery(TMFOUR_QUALIFIER,
        ...
        ResultSet resultSet5 = testUtil.resultSetForSqlQuery(TMTHREE_QUALIFIER,
    ...
    private void assertSuccessfulQueriesOnTmThree() throws SQLException {
        ResultSet resultSet = testUtil.resultSetForSqlQuery(TMTHREE_QUALIFIER,
    ...
    private void assertFailedQueriesOnTmThree() throws SQLException {
        ...
        ResultSet resultSet11 = testUtil.resultSetForSqlQuery(TMTHREE_QUALIFIER,
